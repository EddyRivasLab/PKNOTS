 ...
 */
int 
VH1(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int j, int d, int d1, int d2)
{ 
  int VH1;
...
/* (VH2)__/ VHX + VHX */
int 
VH2(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****vhx, int j, int d, 
...
int 
VH3_1(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_1;
  int i, k, l;
  ...
  if (d1 > 1 && d2 > 1)
    VH3_1 = 2*rnapar->P10P + rnapar->P5P 
...
int 
VH3_2(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_2;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 1)
    VH3_2 = 2*rnapar->P10P + rnapar->P5P + rnapar->P6P 
...
int 
VH3_3(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_3;
  int i, k, l;
  ...
  if(d1 > 1 && d2 > 2)
    VH3_3 = 2*rnapar->P10P + rnapar->P5P + rnapar->P6P 
...
int 
VH3_4(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_4;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 1)
    VH3_4 = 2*rnapar->P10P + rnapar->P5P + rnapar->P6P 
...
int 
VH3_5(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_5;
  int i, k, l;
  ...
  if(d1 > 1 && d2 > 2)
    VH3_5 = 2*rnapar->P10P + rnapar->P5P + rnapar->P6P 
...
int 
VH3_6(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_6;
  int i, k, l;
  ...
  if(d1 > 3 && d2 > 1)
    VH3_6 = 2*rnapar->P10P + rnapar->P5P + 2*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])] 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])] 
...
int 
VH3_7(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_7;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 2)
    VH3_7 = 2*rnapar->P10P + rnapar->P5P + 2*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])]
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])]
...
int 
VH3_8(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_8;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 2)
    VH3_8 = 2*rnapar->P10P + rnapar->P5P + 2*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])]
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])]
...
int 
VH3_9(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_9;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 2)
    VH3_9 = 2*rnapar->P10P + rnapar->P5P + 2*rnapar->P6P 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])]
...
int 
VH3_10(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_10;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 2)
    VH3_10 = 2*rnapar->P10P + rnapar->P5P + 2*rnapar->P6P 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])]
...
int 
VH3_11(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_11;
  int i, k, l;
  ...
  if(d1 > 1 && d2 > 3)
    VH3_11 = 2*rnapar->P10P + rnapar->P5P + 2*rnapar->P6P 
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])]
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])]
...
int 
VH3_12(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_12;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 3)
    VH3_12 = 2*rnapar->P10P + rnapar->P5P + 3*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])] 
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])]
...
int 
VH3_13(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_13;
  int i, k, l;
  ...
  if(d1 > 3 && d2 > 2)
    VH3_13 = 2*rnapar->P10P + rnapar->P5P + 3*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])] 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])] 
...
int 
VH3_14(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_14;
  int i, k, l;
  ...
  if(d1 > 3 && d2 > 2)
    VH3_14 = 2*rnapar->P10P + rnapar->P5P + 3*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])] 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])]
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])]
...
int 
VH3_15(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_15;
  int i, k, l;
  ...
  if(d1 > 2 && d2 > 3)
    VH3_15 = 2*rnapar->P10P + rnapar->P5P + 3*rnapar->P6P 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])]
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])] 
...
int 
VH3_16(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int VH3_16;
  int i, k, l;
  ...
  if(d1 > 3 && d2 > 3)
    VH3_16 = 2*rnapar->P10P + rnapar->P5P + 4*rnapar->P6P 
      + wkn*icfg[idxR(s[i+1])][idxP(s[j],s[i])] 
      + wkn*icfg[idxL(s[k-1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxR(s[l+1])][idxP(s[l],s[k])] 
      + wkn*icfg[idxL(s[j-1])][idxP(s[j],s[i])]
