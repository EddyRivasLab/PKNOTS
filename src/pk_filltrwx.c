...
static void FillWX_pks(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, 
		       int ****whx, int ****yhx, int j, int d);
static void TraceWX_pks(FILE *outf, ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, 
 ...
 */       
void
FillWX(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, 
       int ****whx, int ****yhx, int j, int d)
{

  /* no pseudoknots. (includes: W1-W8).
   */
  FillWX_nested(s, len, rnapar, icfg, wx, vx, j, d);

  /* pseudoknot diagrams (W9-W10).
   */
  FillWX_pks(s, len, rnapar, icfg, wx, vx, whx, yhx, j, d);
}
 ...
 */       
void
TraceWX(FILE *outf, ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, 
	int ****whx, int ****yhx, int j, int d,  
	struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  int fl, *flag;
   ...
   */
  if (*flag == FALSE)
    TraceWX_pks(outf, s, len, rnapar, icfg, wx, vx, whx, yhx, 
 ...
 */       
void
FillWX_nested(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, int j, int d)
{
 ...
 */       
void
TraceWX_nested(FILE *outf, ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, 
	       ...
	       struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  ...
  /* (W1) */
  if (wx[j][d] ==  W1(s, len, rnapar, icfg, vx, j, d)){
  ...
  /* (W2) */
  else if (wx[j][d] == W2(s, len, rnapar, icfg, vx, j, d)){
  ...
  /* (W3) */
  else if (wx[j][d] == W3(s, len, rnapar, icfg, vx, j, d)){
  ...
  /* (W4) */
  else if (wx[j][d] == W4(s, len, rnapar, icfg, vx, j, d)){
  ...
  /* (W5) */
  else if (wx[j][d] == W5(s, len, rnapar, icfg, wx, j, d)){
  ...
  /* (W6) */
  else if (wx[j][d] == W6(s, len, rnapar, icfg, wx, j, d)){
  ...
  for (mid = d-1; mid > 0; mid--) {
    /* (W7) */         
    if (wx[j][d] == W7(s, len, rnapar, icfg, wx, j, d, mid)){
    ...
    /* (W8) */
    /* (W8.1) */
    else if (wx[j][d] == W8_1(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.2) */
    else if (wx[j][d] == W8_2(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.3) */
    else if (wx[j][d] == W8_3(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.4) */
    else if (wx[j][d] == W8_4(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.5) */
    else if (wx[j][d] == W8_5(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.6) */
    else if (wx[j][d] == W8_6(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.7) */
    else if (wx[j][d] == W8_7(s, len, rnapar, icfg, vx, j, d, mid)){
    ...
    /* (W8.8) */
    else if (wx[j][d] == W8_8(s, len, rnapar, icfg, vx, j, d, mid)){
 ...
 */
void
FillWX_pks(ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, 
	   int ****whx, int ****yhx, int j, int d)
{
  int i;
  int mid, mid1, mid2;
  ...
  for (mid = 3; mid < (d-2); mid++)            
	...
	{    
	   ...
	   */
	  /* (W10.1) */
	  if ((sc =  rnapar->P11 + 2*rnapar->P10P + 3*rnapar->P6P
	  ...
	  /* (W10.2) */
	  if (mid-mid1-mid2 > 3 &&
	      (sc = rnapar->P11 + 2*rnapar->P10P + 4*rnapar->P6P
	       + wkn*icfg[idxR(s[i+mid1+1])][idxP(s[i+mid-mid2],s[i+mid1])]     
 ...
 */
void
TraceWX_pks(FILE *outf, ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, int **wx, int **vx, 
	    int ****whx, int ****yhx, int j, int d, int *flag,
	    struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  int mid, mid1, mid2;
  ...
  for (mid = d-3; mid >= 3; mid--)
	...
	/* (W9)__/  2 WHX.
	 */
	if (wx[j][d] == W9(s, len, rnapar, icfg, whx, j, d, mid, mid1, mid2)){
	 ...
	 */
	/* (W10.1) */
	else if (wx[j][d] == W10_1(s, len, rnapar, icfg, yhx, j, d, mid, mid1, mid2)){
	...
	/* (W10.2) */
	else if (wx[j][d] == W10_2(s, len, rnapar, icfg, yhx, j, d, mid, mid1, mid2)){
