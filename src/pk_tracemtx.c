  ...
  while ((curr_tr = PopTraceknstack(dolist)) != NULL)
   {
	...
	TraceVHX(outf, s, len, rnapar, icfg, whx, vhx, 
	...
	TraceVX(outf, s, len, rnapar, icfg, wbx, vx, whx, zhx, yhx, 
	...
	TraceZHX(outf, s, len, rnapar, icfg, wbx, vx, whx, vhx, zhx,  
		 j, d, d1, d2, curr_tr, dolist, traceback);
	break;
	...
	TraceYHX(outf, s, len, rnapar, icfg, wbx, vx, whx, vhx, yhx, 
		 j, d, d1, d2, curr_tr, dolist, traceback);
	break;
	...
	TraceWX(outf, s, len, rnapar, icfg, wx, vx, whx, yhx, 
	...
	TraceWBX(outf, s, len, rnapar, icfg, wbx, vx, whx, yhx, 
		 j, d, approx, curr_tr, dolist, traceback);
	break;
	...
	TraceWHX(outf, s, len, rnapar, icfg, wbx, vx, whx, vhx, zhx, yhx, 
		 j, d, d1, d2, curr_tr, dolist, traceback);
	break;
