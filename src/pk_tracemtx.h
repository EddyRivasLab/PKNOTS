...
extern void TraceMtx_nested(FILE *outf, ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg, 
			    int **wx, int **wbx, int **vx, 
			    int j, int d, struct tracekn_s **ret_trace, int traceback);
extern void TraceMtx(FILE *outf, ESL_DSQ *s, int len, struct rnapar_2 *rnapar, int **icfg,  
		     int **wx, int **wbx, int **vx, 
