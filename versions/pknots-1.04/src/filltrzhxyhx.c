 ...
 */ 
void
FillZHX(int *s, int len, int **icfg, int **wbx, int **vx, 
	 ...
	 int j, int d, int d1, int d2)
{
  ...
  if (d1 > 0 && d2 > 0 && d1 + d2 < d - 1 &&
	...
	bestsc = sc; 
       ...
       */
      if (d1 > 0 && 
	  (sc = P6P + zhx[j][d][d1-1][d2]) > bestsc)
	bestsc = sc;
      
      /* (ZH6)
       */
      if (d2 > 0 && 
	  (sc = P6P + zhx[j][d][d1][d2-1]) > bestsc)
	bestsc = sc; 
 ...
 */ 
void
TraceZHX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
	 int ****whx, int ****vhx, int ****zhx, 
	 int j, int d, int d1, int d2, 
	 struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  ...
  /* (ZH1)__/
   */
  if (zhx[j][d][d1][d2] == ZH1(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (ZH2)__/
   */
  else if (zhx[j][d][d1][d2] == ZH2(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (ZH3)__/
   */
  else if (zhx[j][d][d1][d2] == ZH3(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (ZH4)__/ 
   */
  else if (zhx[j][d][d1][d2] ==  ZH4(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (ZH5)__/ 
   */
  else if (zhx[j][d][d1][d2] == ZH5(s, len, icfg, zhx, j, d, d1, d2)){
  ...
  /* (ZH6)__/
   */
  else if (zhx[j][d][d1][d2] == ZH6(s, len, icfg, zhx, j, d, d1, d2)){
  ...
  for (mid = d1-1; mid > 0; mid--) {
    ...
    /* (ZH7)__/ 1 WBX 1 ZHX
     */                                       
    if (zhx[j][d][d1][d2] == ZH7(s, len, icfg, wbx, zhx, j, d, d1, d2, mid)){
     ...
     */
    /* (ZH8.1) */
    else if (zhx[j][d][d1][d2] == ZH8_1(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_ZH8_1(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }

    /* (ZH8.2) */
    else if (zhx[j][d][d1][d2] == ZH8_2(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_ZH8_2(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }

    /* (ZH8.3) */
    else if (zhx[j][d][d1][d2] == ZH8_3(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_ZH8_3(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
      
    /* (ZH8.4) */
    else if (zhx[j][d][d1][d2] == ZH8_4(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
  ...
  for (mid = d2 - 1; mid > 0; mid--) {
    ...
    /* (ZH9)__/ 1 WBX 1 ZHX
     */  
    if  (zhx[j][d][d1][d2] == ZH9(s, len, icfg, wbx, zhx, j, d, d1, d2, mid)){
     ...
     */ 
    /* (ZH10.1) */
    else if (zhx[j][d][d1][d2] == ZH10_1(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_ZH10_1(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
	    
    /* (ZH10.2) */
    else if (zhx[j][d][d1][d2] == ZH10_2(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_ZH10_2(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
	    
    /* (ZH10.3) */
    else if (zhx[j][d][d1][d2] == ZH10_3(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_ZH10_3(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
	    
    /* (ZH10.4) */
    else if (zhx[j][d][d1][d2] == ZH10_4(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
  ...
  for (mid1 = d1; mid1 > 0; mid1--)
    for (mid2 = d2; mid2 > 0; mid2--)
      if (zhx[j][d][d1][d2] == ZH11(s, len, icfg, zhx, vhx, j, d, d1, d2, mid1, mid2)){
  ...
  /* (ZH12.1) */
  if (zhx[j][d][d1][d2] == ZH12_1(s, len, icfg, whx, j, d, d1, d2)){
    trace_ZH12_1(outf, whx, j, d, d1, d2, curr_tr, dolist, traceback);
    return;
  }
  
  /* (ZH12.2) */
  else  if (zhx[j][d][d1][d2] == ZH12_2(s, len, icfg, whx, j, d, d1, d2)){
    trace_ZH12_2(outf, whx, j, d, d1, d2, curr_tr, dolist, traceback);
    return;
  }
  
  /* (ZH12.3) */
  else  if (zhx[j][d][d1][d2] == ZH12_3(s, len, icfg, whx, j, d, d1, d2)){
    trace_ZH12_3(outf, whx, j, d, d1, d2, curr_tr, dolist, traceback);
    return;
      }
  
  /* (ZH12.4) */
  else  if (zhx[j][d][d1][d2] == ZH12_4(s, len, icfg, whx, j, d, d1, d2)){
 ...
 */ 
void
FillYHX(int *s, int len, int **icfg, int **wbx, int **vx, 
	 ...
	 int j, int d, int d1, int d2, int min_kn)
{
 ...
 if (d1 > 0 && d2 > 0 && d - d1 - d2 > min_kn && 
	...
	bestsc = sc; 
       ...
       */
      if (d1 > 0 && 
	  (sc = P6P + yhx[j][d-1][d1-1][d2]) > bestsc)
	bestsc = sc;
      
      /* (YH6)__/  */
      if (d2 > 0 && 
	  (sc = P6P + yhx[j-1][d-1][d1][d2-1]) > bestsc)
	bestsc = sc; 
 ...
 */ 
void
TraceYHX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
	 int ****whx, int ****vhx, int ****yhx,
	 int j, int d, int d1, int d2, 
	 struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  ...
  /* (YH1)__/  
   */
  if (yhx[j][d][d1][d2] == YH1(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (YH2)__/ 
   */
  else if (yhx[j][d][d1][d2] == YH2(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (YH3)__/
   */
  else if (yhx[j][d][d1][d2] == YH3(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (YH4)__/
   */
  else if (yhx[j][d][d1][d2] == YH4(s, len, icfg, vhx, j, d, d1, d2)){
  ...
  /* (YH5)__/ 
   */
  else if (yhx[j][d][d1][d2] == YH5(s, len, icfg, yhx, j, d, d1, d2)){
  ...
  /* (YH6)__/ 
   */
  else if (yhx[j][d][d1][d2] ==  YH6(s, len, icfg, yhx, j, d, d1, d2)){
  ...
  for (mid = d1-1; mid > 0; mid--) {
    ...
    /* (YH7)__/ 1 WBX 1 YHX
     */                                       
    if (yhx[j][d][d1][d2] == YH7(s, len, icfg, wbx, yhx, j, d, d1, d2, mid)){
     ...
     */                                       
    /* (YH8.1) */
    else if (yhx[j][d][d1][d2] == YH8_1(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_YH8_1(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
  
    /* (YH8.2) */
    else if (yhx[j][d][d1][d2] == YH8_2(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_YH8_2(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }

    /* (YH8.3) */
    else if (yhx[j][d][d1][d2] == YH8_3(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_YH8_3(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    } 

    /* (YH8.4) */
    else if (yhx[j][d][d1][d2] ==  YH8_4(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
  ...
  for (mid = d2 - 1; mid > 0; mid--) {
    ...
    /* (YH9)__/ 1 WBX 1 YHX
     */                                       
    if (yhx[j][d][d1][d2] == YH9(s, len, icfg, wbx, yhx, j, d, d1, d2, mid)){
    ...
    /* (YH10.1) */
    else if (yhx[j][d][d1][d2] == YH10_1(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_YH10_1(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
     
    /* (YH10.2) */
    else if (yhx[j][d][d1][d2] == YH10_2(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_YH10_2(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }
      
    /* (YH10.3) */
    else if (yhx[j][d][d1][d2] == YH10_3(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
      trace_YH10_3(outf, vx, vhx, j, d, d1, d2, mid, curr_tr, dolist, traceback);
      return;
    }	

    /* (YH10.4) */
    else if (yhx[j][d][d1][d2] == YH10_4(s, len, icfg, vx, vhx, j, d, d1, d2, mid)){
  ...
  for (mid1 = d1; mid1 > 0; mid1--)
    for (mid2 = d2; mid2 > 0; mid2--)
      if (yhx[j][d][d1][d2] == YH11(s, len, icfg, yhx, vhx, j, d, d1, d2, mid1, mid2)){
  ...
  /* (YH12.1) */
  if (yhx[j][d][d1][d2] == YH12_1(s, len, icfg, whx, j, d, d1, d2)){
    trace_YH12_1(outf, whx, j, d, d1, d2, curr_tr, dolist, traceback);
    return;
  }
  
  /* (YH12.2) */
  else  if (yhx[j][d][d1][d2] == YH12_2(s, len, icfg, whx, j, d, d1, d2)){
    trace_YH12_2(outf, whx, j, d, d1, d2, curr_tr, dolist, traceback);
    return;
  }
  
  /* (YH12.3) */
  else  if (yhx[j][d][d1][d2] == YH12_3(s, len, icfg, whx, j, d, d1, d2)){
    trace_YH12_3(outf, whx, j, d, d1, d2, curr_tr, dolist, traceback);
    return;
      }
  
  /* (YH12.4) */
  else  if (yhx[j][d][d1][d2] == YH12_4(s, len, icfg, whx, j, d, d1, d2)){
