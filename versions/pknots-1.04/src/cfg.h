...
#define PRELOG    -IntizeScale(1.079)      /* internal(>32), bulge(>32), hairpin (>31)            */   
#define EPARAM1   -IntizeScale(0.0)        /* extra term for stem                                 */
#define EPARAM2   -IntizeScale(0.0)        /* extra term for bulge                                */
#define EPARAM3   -IntizeScale(3.0)        /* extra term for interior loop                        */
#define EPARAM4   -IntizeScale(0.0)        /* extra term for hairpin loop                         */
#define EPARAM5   -IntizeScale(4.6)        /* extra term for multiloop (IS>2) inside vx           */
#define EPARAM5P  -IntizeScale(7.0)        /* extra term for multiloop (IS>2) inside vhx          */
#define EPARAM6   -IntizeScale(0.4)        /* extra term for dangling (inside vx)                 */
#define EPARAM6P  -IntizeScale(0.2)        /* extra term for dangling (in pseudoknots)            */
...
#define EPARAM10  -IntizeScale( 0.1)       /* extra term for base pair in regular multiloops      */
#define EPARAM10P -IntizeScale( 0.1)       /* extra term for base pair in pseudoknot multiloops   */
#define EPARAM11  -IntizeScale( 7.0)       /* penalty for using hole structures under wx          */
#define EPARAM12  -IntizeScale( 6.0)       /* penalty for using hole structures under whx         */
#define EPARAM13  -IntizeScale(16.0)       /* penalty for using hole structures under vx and wbx  */

#define wsf 100   /* weight given to no-knot structures */  
#define wkn 83    /* weight given to knots structures */ 

#define P1   wsf*EPARAM1  
#define P2   wsf*EPARAM2  
#define P3   wsf*EPARAM3  
#define P4   wsf*EPARAM4  
#define P5   wsf*EPARAM5  
#define P5P  wsf*EPARAM5P 
#define P6   wsf*EPARAM6
#define P6P  wsf*EPARAM6P 
#define P9   wsf*EPARAM9
#define P10  wsf*EPARAM10
#define P10P wkn*EPARAM10P
#define P11  wsf*EPARAM11
#define P12  wsf*EPARAM12
#define P13  wsf*EPARAM13
