...
static void FillVX_pks(int *s, int len, int **icfg, int **wbx, int **vx, 
		       int ****whx, int ****zhx, int ****yhx, int j, int d);
static void TraceVX_pks(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
 ...
 */       
void
FillVX(int *s, int len, int **icfg, int **wbx, int **vx, int *vp, 
       int ****whx, int ****zhx, int ****yhx, int j, int d, int allow_coaxials, int approx)
{
  ...
  */
  if (!approx) 
    FillVX_pks(s, len, icfg, wbx, vx, whx, zhx, yhx, j, d); 
 ...
 */       
void
TraceVX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx,  
	...
	struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  ...
  TraceVX_pks(outf, s, len, icfg, wbx, vx, whx, zhx, yhx, 
 ...
 */       
void 
FillVP(int *s, int len, int **icfg, int **vx, int *vp, int j, int d)
{
 ...
 */       
void
FillVX_nested(int *s, int len, int **icfg, int **wbx, int **vx, int *vp, 
	      int j, int d, int allow_coaxials)
{
  ...
  if (icfg[idxS][idxP(s[i],s[j])] == 1*INTSCALE)
    { 
      ...
      /* STEMS
       */
      if ((sc = wsf*F2(s, len, icfg, j, d, 1, 1)
	   + vx[j-1][d-2]) > bestsc)
	bestsc = sc;
	...
	{                      
	  ...
	  if (mid < d-6 &&
	      (sc = 2*P10 + P5 + 3*P6 
	       ...
	       + wsf*icfg[idxR(s[i+mid+3])][idxP(s[i+2],s[i+mid+2])]
	       + wsf*icfg[idxPS(s[i],s[j])][idxPS(s[i+2],s[i+2+mid])] 
	       + vx[i+1+mid][mid] + wbx[j-2][d-mid-6]) > bestsc)
	    bestsc = sc;
 ...
 */       
void
TraceVX_nested(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, int j, int d,  
	       int *flag, struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  ...
  for (mid1 = 1; mid1 < d-1; mid1++)
    for (mid2 = 1; mid2 < d-mid1; mid2++)
      if (vx[j][d] == V2(s, len, icfg, vx, j, d, mid1, mid2)) {
	trace_V2(outf, vx, s, len, icfg, j, d, mid1, mid2, curr_tr, dolist, traceback);
	*flag = TRUE;
	return;
      }
  ...
  for (mid = 1; mid < d-3; mid++)
    {
      ...
      /* (V3_1) */
      if (vx[j][d] == V3_1(s, len, icfg, wbx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V3_2) */
      else if (vx[j][d] == V3_2(s, len, icfg, wbx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V3_3) */
      else if (vx[j][d] == V3_3(s, len, icfg, wbx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V3_4) */
      else if (vx[j][d] == V3_4(s, len, icfg, wbx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_1) */
      else if (vx[j][d] == V4_1(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_2) */
      else if (vx[j][d] == V4_2(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_3) */
      else if (vx[j][d] == V4_3(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_4) */
      else if (vx[j][d] == V4_4(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_5) */
      else if (vx[j][d] == V4_5(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_6) */
      else if (vx[j][d] == V4_6(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_7) */
      else if (vx[j][d] == V4_7(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V4_8) */
      else if (vx[j][d] == V4_8(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_1) */
      else if (vx[j][d] == V5_1(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_2)  */
      else if (vx[j][d] == V5_2(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_3)  */
      else if (vx[j][d] == V5_3(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_4) */
      else if (vx[j][d] == V5_4(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_5) */
      else if (vx[j][d] == V5_5(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_6)  */
      else if (vx[j][d] == V5_6(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_7)  */
      else if (vx[j][d] == V5_7(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	return;
      ...
      /* (V5_8) */
      else if (vx[j][d] == V5_8(s, len, icfg, wbx, vx, j, d, mid)){
	...
	*flag = TRUE;
	...
	for (mid2 = 1; mid2 < d-mid-mid1-1; mid2++) {
	  ...
	  /* (V6_1) */
	  if (vx[j][d] == V6_1(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V6_2a) */
	  else if (vx[j][d] == V6_2a(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_2b) */
	  else if (vx[j][d] == V6_2b(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_2c) */
	  else if (vx[j][d] == V6_2c(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_3a) */
	  else if (vx[j][d] == V6_3a(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_3b) */
	  else if (vx[j][d] == V6_3b(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_3c) */
	  else if (vx[j][d] == V6_3c(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4a) */
 	  else if (vx[j][d] == V6_4a(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4b) */
 	  else if (vx[j][d] == V6_4b(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4c) */
	  else if (vx[j][d] == V6_4c(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4d) */
	  else if (vx[j][d] == V6_4d(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4e) */
 	  else if (vx[j][d] == V6_4e(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4f) */
	  else if (vx[j][d] == V6_4f(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4g) */
 	  else if (vx[j][d] == V6_4g(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4h) */
 	  else if (vx[j][d] == V6_4h(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_4i) */
 	  else if (vx[j][d] == V6_4i(s, len, icfg, vx, j, d,  mid, mid1, mid2)){
	    trace_V6_CC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_5) */
	  if (vx[j][d] == V6_5(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V6_6a) */
	  else if (vx[j][d] == V6_6a(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_6b) */
	  else if (vx[j][d] == V6_6b(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_6c) */
	  else if (vx[j][d] == V6_6c(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_7a) */
	  else if (vx[j][d] == V6_7a(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_7b) */
	  else if (vx[j][d] == V6_7b(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_7c) */
	  else if (vx[j][d] == V6_7c(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8a) */
 	  else if (vx[j][d] == V6_8a(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8b) */
 	  else if (vx[j][d] == V6_8b(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8c) */
	  else if (vx[j][d] == V6_8c(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8d) */
	  else if (vx[j][d] == V6_8d(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8e) */
 	  else if (vx[j][d] == V6_8e(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8f) */
	  else if (vx[j][d] == V6_8f(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8g) */
 	  else if (vx[j][d] == V6_8g(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8h) */
 	  else if (vx[j][d] == V6_8h(s, len, icfg, vx, j, d, mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
	  ...
	  /* (V6_8i) */
 	  else if (vx[j][d] == V6_8i(s, len, icfg, vx, j, d,  mid, mid1, mid2)){
	    trace_V6_NCC(outf, vx, j, d, mid, mid1, mid2, curr_tr, dolist, traceback);
	    *flag = TRUE;
	    return;
	  }
 ...
 */     
void 
FillVX_pks(int *s, int len, int **icfg, int **wbx, int **vx, 
	   int ****whx, int ****zhx, int ****yhx, int j, int d)
{
  int               i;
  int              sc;
 ...
 */      
void 
TraceVX_pks(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
	    int ****whx, int ****zhx, int ****yhx, int j, int d, int *flag,
	    struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback)
{
  int               i;
  ...
  i = j - d;
	...
	for (mid2 = 0; mid2 < mid-mid1-2; mid2++){
	  ...
	  /* (V7.1) */
	  if (vx[j][d] == V7_1(s, len, icfg, whx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V7.2) */
	  else if (vx[j][d] == V7_2(s, len, icfg, whx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V7.3) */
	  else if (vx[j][d] == V7_3(s, len, icfg, whx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V7.4) */
	  else if (vx[j][d] == V7_4(s, len, icfg, whx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V8.1) */
	  else if (vx[j][d] == V8_1(s, len, icfg, whx, zhx,  j, d, mid, mid1, mid2)){
	  ...
	  /* (V8.2) */
	  else if (vx[j][d] == V8_2(s, len, icfg, whx, zhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V8.3) */
	  else if (vx[j][d] == V8_3(s, len, icfg, whx, zhx,  j, d, mid, mid1, mid2)){
	  ...
	  /* (V8.4) */
	  else if (vx[j][d] == V8_4(s, len, icfg, whx, zhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V9.1) */
	  else if (vx[j][d] == V9_1(s, len, icfg, whx, zhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V9.2) */
	  else if (vx[j][d] == V9_2(s, len, icfg, whx, zhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V9.3) */
	  else if (vx[j][d] == V9_3(s, len, icfg, whx, zhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V9.4) */
	  else if (vx[j][d] == V9_4(s, len, icfg, whx, zhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.1) */
	  else if (vx[j][d] == V10_1(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.2) */
	  else if (vx[j][d] ==  V10_2(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.3) */
	  else if (vx[j][d] == V10_3(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.4) */
	  else if (vx[j][d] ==  V10_4(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.5) */
	  else if (vx[j][d] == V10_5(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.6) */
	  else if (vx[j][d] ==  V10_6(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.7) */
	  else if (vx[j][d] == V10_7(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
	  ...
	  /* (V10.8) */
	  else if (vx[j][d] ==  V10_8(s, len, icfg, yhx, j, d, mid, mid1, mid2)){
