 ...
 */
extern void FillMtx_nested(int *s, int len, int **icfg, int **wx, int **wbx, int **vx, int *vp, 
			   int allow_coaxials);
extern void FillMtx(int *s, int len, int **icfg, int **wx, int **wbx, int **vx, int *vp,
		    int ****whx, int ****vhx, int ****zhx, int ****yhx, int allow_coaxials, int approx);

/* from filltrvx.c: fill and traceback vx matrix
 */
extern void FillVP(int *s, int len, int **icfg, int **vx, int *vp, int j, int d);
extern void FillVX_nested(int *s, int len, int **icfg, int **wbx, int **vx, int *vp, int j, int d, 
			  int allow_coaxials);
extern void TraceVX_nested(FILE *outf, int *s, int len, int **icfg, 
			   int **wbx, int **vx, int j, int d, int *flag,
			   struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern void  FillVX(int *s, int len, int **icfg, int **wbx, int **vx, int *vp,
		    int ****whx, int ****zhx, int ****yhx, int j, int d, int allow_coaxials, int approx);
extern void TraceVX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx,  
		    int ****whx, int ****zhx, int ****yhx, int j, int d, int approx,
		    struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);

/* from filltrwx.c: fill and traceback wx, wbx matrices
 */
extern void  FillWX_nested(int *s, int len, int **icfg, int **wx, int **vx, int j, int d);
extern void TraceWX_nested(FILE *outf, int *s, int len, int **icfg, 
			   int **wx, int **vx, int j, int d, int *flag,  
			   struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern void  FillWX(int *s, int len, int **icfg, int **wx, int **vx, 
		    int ****whx, int ****yhx, int j, int d);
extern void TraceWX(FILE *outf, int *s, int len, int **icfg, int **wx, int **vx, 
		    int ****whx, int ****yhx, int j, int d, 
		    struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);

/* from filltrwxwbx.c: fill and traceback wx, wbx matrices
 */
extern void FillWBX_nested(int *s, int len, int **icfg, int **wbx, int **vx, int j, int d);
extern void TraceWBX_nested(FILE *outf, int *s, int len, int **icfg, 
			    int **wbx, int **vx, int j, int d, int *flag,  
			    struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern void  FillWBX(int *s, int len, int **icfg, int **wbx, int **vx, 
		     int ****whx, int ****yhx, int j, int d, int approx);
extern void TraceWBX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
		     int ****whx, int ****yhx, int j, int d, int approx, 
		     struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);

/* from filltrvhx.c: fill and traceback vhx matrix
 */
extern void FillVHX(int *s, int len, int **icfg, int ****whx, int ****vhx, 
		    int j, int d, int d1, int d2, int min_kn);
extern void TraceVHX(FILE *outf, int *s, int len, int **icfg, int ****whx, int ****vhx, 
		     int j, int d, int d1, int d2, 
		     struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);

/* from filltrzhxyhx.c: fill and traceback zhx, yhx  matrices
 */
extern void FillZHX(int *s, int len, int **icfg,int **wbx, int **vx, 
		    int ****whx, int ****vhx, int ****zhx, 
		    int j, int d, int d1, int d2);
extern void TraceZHX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
		     int ****whx, int ****vhx, int ****zhx,
		     int j, int d, int d1, int d2, 
		     struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern void FillYHX(int *s, int len, int **icfg, int **wbx, int **vx, 
		    int ****whx, int ****vhx, int ****yhx,
		    int j, int d, int d1, int d2, int min_kn);
extern void TraceYHX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
		     int ****whx, int ****vhx, int ****yhx,
		     int j, int d, int d1, int d2, 
		     struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
 ...
 */
extern void FillWHX(int *s, int len, int **icfg, int **wbx, int **vx, 
		    int ****whx, int ****vhx, int ****zhx, int ****yhx,
		    int j, int d, int d1, int d2);
extern void TraceWHX(FILE *outf, int *s, int len, int **icfg, int **wbx, int **vx, 
		     int ****whx, int ****vhx, int ****zhx, int ****yhx,
		     int j, int d, int d1, int d2,
		     struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
 ...
 */
extern void  FillVPScan(int *s, int len, int win, int **icfg, 
			int **vx, int *vp, int j, int jmod, int d);
extern void  FillVX_nestedScan(int *s, int len, int win, int **icfg, 
			       int **wbx, int **vx, int *vp, int j, int jmod, int d);

/* from fillwbxscan.c: fill and traceback wx, wbx matrices
 */
extern void FillWBX_nestedScan(int *s, int len, int win, int **icfg, int **wbx, int **vx,  
			       int j, int jmod, int d);

/* from fillwxscan.c: fill and traceback wx, wbx matrices 
 */
extern void  FillWX_nestedScan(int *s, int len, int win, int **icfg, int **wx, int **vx,  
			       int j, int jmod, int d);

/* from irredsurf.c: calculates F1 and F2
 */
extern int F1(int *s, int len, int **icfg, int j, int d);
extern int F2(int *s, int len, int **icfg, int j, int d, int d1, int d2);
 ...
 */
extern void TraceMtx_nested(FILE *outf, int *s, int len, int **icfg,
			    int **wx, int **wbx, int **vx, 
			    int j, int d, struct tracekn_s **ret_trace, int traceback);
extern void TraceMtx(FILE *outf, int *s, int len, int **icfg,
		     int **wx, int **wbx, int **vx, 
		     int ****whx, int ****vhx, int ****zhx, int ****yhx,
...
extern void Free_Mgp(int len, int ****whx, int ****vhx,
		     int ****zhx, int ****yhx);
extern void Print_2DMtx(FILE *fp, int **mtx, int len);
extern void Print_4DMtx(FILE *fp, int ****mtx, int len);
extern void StructurePredictkn_2IS(FILE *outf, char *seq, int len,
