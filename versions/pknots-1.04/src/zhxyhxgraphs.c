...
/* (ZH1)__/ pair k,l */
int 
ZH1(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     ZH1;
  int i, k, l;
...
/* (ZH2)__/  pair k+1,l-1 */
int 
ZH2(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     ZH2;
  int i, k, l;
...
int 
ZH3(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     ZH3;
  int i, k, l;
 ...
 */
int
ZH4(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     ZH4;
  int i, k, l;
...
int 
ZH5(int *s, int len, int **icfg, int ****zhx, int j, int d, int d1, int d2)
{ 
  int     ZH5;
  int i, k, l;
...
int 
ZH6(int *s, int len, int **icfg, int ****zhx, int j, int d, int d1, int d2)
{ 
  int     ZH6;
  int i, k, l;
 ...
 */                                       
int 
ZH7(int *s, int len, int **icfg, int **wbx,int ****zhx, int j, int d, int d1, int d2,int mid)
{ 
  int     ZH7;
  int i, k, l;
...
int 
ZH8_1(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   ZH8_1;
  int i, k, l;
...
int 
ZH8_2(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   ZH8_2;
  int i, k, l;
...
int 
ZH8_3(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   ZH8_3;
  int i, k, l;
...
int 
ZH8_4(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   ZH8_4;
  int i, k, l;
 ...
 */  
int 
ZH9(int *s, int len, int **icfg, int **wbx,int ****zhx, int j, int d, int d1, int d2, int mid)
{ 
  int     ZH9;
  int i, k, l;
...
int 
ZH10_1(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int  ZH10_1;
  int i, k, l;
...
int 
ZH10_2(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   ZH10_2;
  int i, k, l;
...
int 
ZH10_3(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   ZH10_3;
  int i, k, l;
...
int 
ZH10_4(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int  ZH10_4;
  int i, k, l;
 ...
 */
int 
ZH11(int *s, int len, int **icfg, int ****zhx,int ****vhx, 
...
int 
ZH12_1(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int ZH12_1;
  int i, k, l;
...
int 
ZH12_2(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int ZH12_2;
  int i, k, l;
...
int 
ZH12_3(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int ZH12_3;
  int i, k, l;
...
int 
ZH12_4(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int ZH12_4;
  int i, k, l;
...
/* (YH1)__/ pair k,l */
int 
YH1(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     YH1;
  int i, k, l;
...
/* (YH2)__/ pair i+1,j-1  */
int 
YH2(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     YH2;
  int i, k, l;
...
int 
YH3(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     YH3;
  int i, k, l;
...
int 
YH4(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2)
{ 
  int     YH4;
  int i, k, l;
...
int 
YH5(int *s, int len, int **icfg, int ****yhx, int j, int d, int d1, int d2)
{ 
  int     YH5;
  int i, k, l;
...
int 
YH6(int *s, int len, int **icfg, int ****yhx, int j, int d, int d1, int d2)
{ 
  int     YH6;
  int i, k, l;
 ...
 */                                       
int 
YH7(int *s, int len, int **icfg, int **wbx,int ****yhx, int j, int d, int d1, int d2,int mid)
{ 
  int     YH7;
  int i, k, l;
...
int 
YH8_1(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   YH8_1;
  int i, k, l;
...
int 
YH8_2(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   YH8_2;
  int i, k, l;
...
int 
YH8_3(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   YH8_3;
  int i, k, l;
...
int 
YH8_4(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   YH8_4;
  int i, k, l;
 ...
 */                                       
int 
YH9(int *s, int len, int **icfg, int **wbx,int ****yhx, int j, int d, int d1, int d2, int mid)
{ 
  int     YH9;
  int i, k, l;
...
int 
YH10_1(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int  YH10_1;
  int i, k, l;
...
int 
YH10_2(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   YH10_2;
  int i, k, l;
...
int 
YH10_3(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int   YH10_3;
  int i, k, l;
...
int 
YH10_4(int *s, int len, int **icfg, int **vx,int ****vhx, int j, int d, int d1, int d2,int mid)
{ 
  int  YH10_4;
  int i, k, l;
 ...
 */
int 
YH11(int *s, int len, int **icfg, int ****yhx,int ****vhx, 
     int j, int d, int d1, int d2, int mid1, int mid2)
{ 
  int    YH11;
  int i, k, l;
...
int 
YH12_1(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int YH12_1;
  int i, k, l;
...
int 
YH12_2(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int YH12_2;
  int i, k, l;
...
int 
YH12_3(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int YH12_3;
  int i, k, l;
...
int 
YH12_4(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2)
{ 
  int YH12_4;
  int i, k, l;
