...
extern int ZH1(int *s, int len, int **icfg, int ****vhx, int j, int d, int d1, int d2);
...
extern int ZH12_1(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2);
extern void trace_ZH12_1(FILE *outf, int ****whx, int j, int d, int d1, int d2,
			struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern int ZH12_2(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2);
extern void trace_ZH12_2(FILE *outf, int ****whx, int j, int d, int d1, int d2,
			struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern int ZH12_3(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2);
extern void trace_ZH12_3(FILE *outf, int ****whx, int j, int d, int d1, int d2,
			struct tracekn_s *curr_tr, struct traceknstack_s *dolist, int traceback);
extern int ZH12_4(int *s, int len, int **icfg, int ****whx, int j, int d, int d1, int d2);
