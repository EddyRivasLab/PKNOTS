 ...
 */
int
WB1(int *s, int len, int **icfg, int **vx, int j, int d)
{ 
  int WB1;
  int i;
 ...
 */
int
WB2(int *s, int len, int **icfg, int **vx, int j, int d)
{ 
  int WB2;
  int i;
 ...
 */
int
WB3(int *s, int len, int **icfg, int **vx, int j, int d)
{ 
  int WB3;
  int i;
 ...
 */
int
WB4(int *s, int len, int **icfg, int **vx, int j, int d)
{ 
  int WB4;
  int i;
 ...
 */
int
WB5(int *s, int len, int **icfg, int **wbx, int j, int d)
{ 
  int WB5;
  int i;
 ...
 */
int
WB6(int *s, int len, int **icfg, int **wbx, int j, int d)
{ 
  int WB6;
  int i;
 ...
 */
int
WB7(int *s, int len, int **icfg, int **wbx, int j, int d, int mid)
{ 
  int WB7;
  int i;
...
int
WB8_1(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_1;
  int i;
...
int
WB8_2(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_2;
  int i;
...
int
WB8_3(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_3;
  int i;
...
int
WB8_4(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_4;
  int i;
...
int
WB8_5(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_5;
  int i;
...
int
WB8_6(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_6;
  int i;
...
int
WB8_7(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_7;
  int i;
...
int
WB8_8(int *s, int len, int **icfg, int **vx, int j, int d, int mid)
{ 
  int WB8_8;
  int i;
 ...
 */
int
WB9(int *s, int len, int **icfg, int ****whx, int j, int d, int mid, int mid1, int mid2)
{ 
  int WB9;
  int i;
...
int
WB10_1(int *s, int len, int **icfg, int ****yhx, 
...
/* (WB10.2)__/ non-contiguous coaxial: i+mid-mid2-2, i+mid-mid2 /
            ...
            / i+mid+2  dangles left  off i+mid+3,i+mid-mid2-1  */
int
WB10_2(int *s, int len, int **icfg, int ****yhx, 
       int j, int d, int mid, int mid1, int mid2)
{ 
  int WB10_2;
  int i;
